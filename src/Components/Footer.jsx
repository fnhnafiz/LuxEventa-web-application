...
function Footer() {
  ...
  const stats = [
    { icon: Calendar, value: "10K+", label: "Events Created" },
    { icon: Users, value: "50K+", label: "Happy Users" },
    { icon: Sparkles, value: "500+", label: "Cities Covered" },
  ];

  return (
    <footer className="relative bg-gradient-to-r from-red-500 to-orange-500 text-white overflow-hidden">
              ...
              {stats.map((stat, index) => (
                ...
                >
                  <div className="flex items-center justify-center mb-2">
                    <stat.icon className="w-8 h-8 mr-2 group-hover:animate-pulse" />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
              ...
              <div className="lg:col-span-1">
                <div className="mb-6">
                  <h2 className="text-3xl font-bold mb-3 flex items-center">
                    ...
                    <span className="text-yellow-300">Eventa</span>
                  </h2>
                  <p className="text-white/90 leading-relaxed">
                    Transform your events into unforgettable experiences. From
                    intimate gatherings to grand celebrations, we make every
                    moment magical.
                  </p>
                </div>
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center group hover:translate-x-2 transition-transform">
                    ...
                    <span className="text-white/90">support@luxeventa.com</span>
                  </div>
                  <div className="flex items-center group hover:translate-x-2 transition-transform">
              ...
              <div>
                ...
                <p className="text-white/90 mb-4">
                  Get the latest events and exclusive offers delivered to your
                  inbox.
                </p>
                <div onSubmit={handleSubscribe} className="space-y-3">
                  <div className="relative">
                    <input
                      ...
                      className="w-full px-4 py-3 rounded-lg bg-white/20 backdrop-blur border border-white/30 text-white placeholder-white/70 focus:outline-none focus:ring-2 focus:ring-yellow-300 focus:border-transparent transition-all"
                    />
                  </div>
                  <button
                    type="button"
                    ...
                    className="w-full px-4 py-3 bg-yellow-400 hover:bg-yellow-300 text-orange-600 font-semibold rounded-lg transition-all duration-300 hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center"
                  >
                    {isSubscribed ? (
                      <>
          ...
          <div className="max-w-7xl mx-auto px-4 py-6">
            <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
              <div className="text-white/90 text-sm flex items-center">
                &copy; {year} LuxEventa. All rights reserved. Made with
